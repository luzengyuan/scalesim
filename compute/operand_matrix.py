...
class operand_matrix(object):
    def __init__(self):
        ...
        # Address matrices
        self.ifmap_addr_matrix = np.ones((self.ofmap_px_per_filt, self.conv_window_size), dtype=np.int_)
        self.filter_addr_matrix = np.ones((self.conv_window_size, self.num_filters), dtype=np.int_)
        self.ofmap_addr_matrix = np.ones((self.ofmap_px_per_filt, self.num_filters), dtype=np.int_)
...
if __name__ == '__main__':
    ...
    for i in range(tutil.get_num_layers()):
        ...
        print(layer_param_arr)
        print(ofmap_dims)
        print(ofmap_px_filt)
        print(conv_window_size)
        print(layer_calc_hyper_param_arr)